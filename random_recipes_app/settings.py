"""
Django settings for random_recipes_app project.
...
MIDDLEWARE = [
    'rr_app.middleware.DisableCacheMiddleware',
...
ROOT_URLCONF = 'random_recipes_app.urls'
...
WSGI_APPLICATION = 'random_recipes_app.wsgi.application'
